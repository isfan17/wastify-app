...
class HomeFragment : Fragment() {
            ...
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                ...
                launch {
                    viewModel.results.collectLatest {
                        if (it != null) binding.tvWasteIdentified.text = it.size.toString()
                    }
                }
                launch {
                    viewModel.fetchSavedResultsResult.collectLatest {
                        if (it != null) {
                            when (it) {
                                ...
                                is UiState.Success -> showStatsLoading(false)
                            }
                        }
                    }
                }
    ...
    private fun showStatsLoading(state: Boolean) {
        binding.apply {
            progressBarStatOne.isVisible = state
            progressBarStatTwo.isVisible = state
        }
    }
